        ...
        Form {
            ...
            settingsSection(
                ...
                Group {
                    ...
                    Picker("Listening", selection: Binding(
                        get: { configuration.configuration.pipeline.conversation.agentListeningMode },
                        set: { value in configuration.update { $0.pipeline.conversation.agentListeningMode = value } }
                    )) {
